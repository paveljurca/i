...
=head1 [WORK IN PROGRESS, 2017/11/24]

B<Hosted on GitHub>, please see L<https://github.com/paveljurca/installed>.

=cut

=head2 Installed

Scan given PCs for installed SW.

Dependency:

Download PsExec and put it in the same folder or in your %PATH%.
...
=> test for the directory is NON empty

NOTE_TO_SELF:
"If you omit the computer name, PsExec runs the application on the local system"


!!!!!!!!!! for check on network drives needs to be present "-u" and "-p" parameters, i.e. type login explicitly
